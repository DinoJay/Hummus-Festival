...
console.log('d3 array', group, 'timeFormat', timeFormat);
      ...
      <div onClick={onClick} ref={ref} className="h-full w-full flex flex-col">
        ...
        <div className="flex justify-end">
          <button
            type="button"
            onClick={onClick}
            className="px-2 flex md:hover:shadow-lg text-center cursor-pointer sketchy-font-2 text-end font-bold text-4xl z-20">
            back
          </button>
        </div>
      </div>
...
const smallScreen = useMedia(
  ...
  const tmpGroupedEvents = Array.from(grouped.entries()).map((d, i) => {
    console.log('d', d);
    const [ key, value]=d;
